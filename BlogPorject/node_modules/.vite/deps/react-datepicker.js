...
function isTimeInDisabledRange(time, _a2) {
  ...
  var min2 = newDate();
  min2 = setHours(min2, getHours(minTime2));
  min2 = setMinutes(min2, getMinutes(minTime2));
  min2 = setSeconds(min2, getSeconds(minTime2));
  var max2 = newDate();
  max2 = setHours(max2, getHours(maxTime2));
  max2 = setMinutes(max2, getMinutes(maxTime2));
  max2 = setSeconds(max2, getSeconds(maxTime2));
  var valid;
  try {
  ...
  function(_super) {
    ...
    function InputTime2(props) {
      ...
      _this.renderTimeInput = function() {
        ...
        return import_react2.default.createElement("input", { type: "time", className: "react-datepicker-time__input", placeholder: "Time", name: "time-input", required: true, value: time, onChange: function(event) {
    ...
    function Week2() {
      ...
      _this.renderDays = function() {
        ...
        if (_this.props.showWeekNumber) {
          ...
          days.push(import_react2.default.createElement(WeekNumber, _assign({ key: "W" }, Week2.defaultProps, _this.props, { weekNumber, date: startOfWeek2, onClick: onClickAction })));
        }
  ...
  function(_super) {
    ...
    function MonthDropdown2() {
      ...
      _this.renderDropdown = function(monthNames) {
        return import_react2.default.createElement(WrappedMonthDropdownOptions, _assign({ key: "dropdown" }, _this.props, { monthNames, onChange: _this.onChange, onCancel: _this.toggleDropdown }));
      };
...
var MonthYearDropdownOptions = (
  ...
  function(_super) {
    ...
    MonthYearDropdownOptions2.prototype.render = function() {
      ...
      return import_react2.default.createElement("div", { className: dropdownClass }, this.renderOptions());
    };
  ...
  function(_super) {
    ...
    function MonthYearDropdown2() {
      ...
      _this.renderDropdown = function() {
        return import_react2.default.createElement(WrappedMonthYearDropdownOptions, _assign({ key: "dropdown" }, _this.props, { onChange: _this.onChange, onCancel: _this.toggleDropdown }));
      };
    ...
    Time2.prototype.render = function() {
      ...
      return import_react2.default.createElement(
        ...
        import_react2.default.createElement(
          ...
          import_react2.default.createElement("div", { className: "react-datepicker-time__header" }, this.props.timeCaption)
        ),
        import_react2.default.createElement(
          "div",
...
var YearDropdownOptions = (
  ...
  function(_super) {
    ...
    YearDropdownOptions2.prototype.render = function() {
      ...
      return import_react2.default.createElement("div", { className: dropdownClass, ref: this.dropdownRef }, this.renderOptions());
    };
...
var YearDropdown = (
  ...
  function(_super) {
    ...
    function YearDropdown2() {
      ...
      _this.renderDropdown = function() {
        return import_react2.default.createElement(WrappedYearDropdownOptions, _assign({ key: "dropdown" }, _this.props, { onChange: _this.onChange, onCancel: _this.toggleDropdown }));
      };
      _this.renderScrollMode = function() {
        var dropdownVisible = _this.state.dropdownVisible;
        var result = [_this.renderReadView(!dropdownVisible)];
...
function withFloating(Component3) {
  var WithFloating = function(props) {
    ...
    return import_react2.default.createElement(Component3, _assign({}, componentProps));
  };
  return WithFloating;
}
var PopperComponent = (
  ...
  function(_super) {
    ...
    function DatePicker2(props) {
      ...
      _this.renderCalendar = function() {
        ...
        return import_react2.default.createElement(WrappedCalendar, _assign({ ref: function(elem) {
          _this.calendar = elem;
