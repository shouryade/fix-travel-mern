import {
  ...
  useRole,
  useTypeahead
} from "./chunk-IMVLGZNP.js";
import "./chunk-OL2EO3PE.js";
import {
  require_classnames
} from "./chunk-VRMGGKRW.js";
import {
  require_jsx_runtime
...
var Badge = ({
  ...
  const Content = () => (0, import_jsx_runtime9.jsxs)(
    "span",
    {
      ...
      ...props,
      children: [
        Icon && (0, import_jsx_runtime9.jsx)(Icon, { "aria-hidden": true, className: theme2.icon.size[size], "data-testid": "flowbite-badge-icon" }),
...
var processChildren = (children, outline, pill) => {
  return import_react7.Children.map(children, (child, index) => {
    if ((0, import_react7.isValidElement)(child)) {
      if (child.props.children) {
        return (0, import_react7.cloneElement)(child, {
          ...
          positionInGroup: determinePosition(index, import_react7.Children.count(children))
        });
      } else {
        return (0, import_react7.cloneElement)(child, {
          outline,
...
var determinePosition = (index, totalChildren) => {
        ...
        children: (0, import_jsx_runtime12.jsx)(
          "span",
          {
            ...
            children: (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
              isProcessing && (0, import_jsx_runtime12.jsx)("span", { className: twMerge(theme2.spinnerSlot, theme2.spinnerLeftPosition[size]), children: processingSpinner || (0, import_jsx_runtime12.jsx)(Spinner, { size }) }),
      ...
      children: [
        (0, import_jsx_runtime20.jsx)(
          ScrollContainer,
          {
            ...
            children: items == null ? void 0 : items.map((item, index) => (0, import_jsx_runtime20.jsx)(
              "div",
              {
        ...
        indicators && (0, import_jsx_runtime20.jsx)("div", { className: theme2.indicators.wrapper, children: items == null ? void 0 : items.map((_, index) => (0, import_jsx_runtime20.jsx)(
          "button",
          {
            className: twMerge(theme2.indicators.base, theme2.indicators.active[index === activeItem ? "on" : "off"]),
...
var DatepickerViewsDays = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime25.jsxs)(import_jsx_runtime25.Fragment, { children: [
    (0, import_jsx_runtime25.jsx)("div", { className: theme2.header.base, children: weekDays.map((day, index) => (0, import_jsx_runtime25.jsx)("span", { className: theme2.header.title, children: day }, index)) }),
    (0, import_jsx_runtime25.jsx)("div", { className: theme2.items.base, children: [...Array(42)].map((_date, index) => {
...
var DatepickerViewsDecades = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime26.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_year, index) => {
...
var DatepickerViewsMonth = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime27.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_month, index) => {
...
var DatepickerViewsYears = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime28.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_year, index) => {
  ...
  return (0, import_jsx_runtime29.jsx)(
    DatepickerContext.Provider,
    {
      ...
      children: (0, import_jsx_runtime29.jsxs)("div", { className: twMerge(theme2.root.base, className), children: [
        !inline && (0, import_jsx_runtime29.jsx)(
          TextInput,
          {
        ...
        (isOpen || inline) && (0, import_jsx_runtime29.jsx)("div", { ref: datepickerRef, className: twMerge(theme2.popup.root.base, inline && theme2.popup.root.inline), children: (0, import_jsx_runtime29.jsxs)("div", { className: theme2.popup.root.inner, children: [
...
var DropdownContext = (0, import_react24.createContext)(void 0);
function useDropdownContext() {
  const context = (0, import_react24.useContext)(DropdownContext);
  if (!context) {
...
var DropdownItem = (0, import_react26.forwardRef)(
...
var Trigger = ({
  ...
  if (renderTrigger) {
    ...
    return (0, import_react28.cloneElement)(triggerElement, { ref: refs.setReference, disabled, ...a11yProps, ...triggerElement.props });
  }
  return inline ? (0, import_jsx_runtime36.jsx)("button", { type: "button", ref: refs.setReference, className: theme2 == null ? void 0 : theme2.inlineWrapper, disabled, ...a11yProps, children }) : (0, import_jsx_runtime36.jsx)(Button, { ...buttonProps, disabled, type: "button", ref: refs.setReference, ...a11yProps, children });
};
var DropdownComponent = ({
  ...
  const [activeIndex, setActiveIndex] = (0, import_react28.useState)(null);
  const [selectedIndex, setSelectedIndex] = (0, import_react28.useState)(null);
  const [buttonWidth, setButtonWidth] = (0, import_react28.useState)(void 0);
  const elementsRef = (0, import_react28.useRef)([]);
  const labelsRef = (0, import_react28.useRef)([]);
  ...
  const handleSelect = (0, import_react28.useCallback)((index) => {
    setSelectedIndex(index);
    setOpen(false);
  }, []);
  const handleTypeaheadMatch = (0, import_react28.useCallback)(
    (index) => {
      if (open) {
  ...
  const Icon = (0, import_react28.useMemo)(() => {
...
var FileInput = (0, import_react29.forwardRef)(
...
var FloatingLabel = (0, import_react30.forwardRef)(
  ({
    label,
    helperText,
    color = "default",
    ...
    const randomId = (0, import_react30.useId)();
...
var MegaMenuDropdown = ({
  ...
  const [labelledBy, setLabelledBy] = (0, import_react33.useState)(void 0);
...
var MegaMenuDropdownToggle = ({
  ...
  const [controls, setControls] = (0, import_react34.useState)(void 0);
  const [isExpanded, setExpanded] = (0, import_react34.useState)(void 0);
...
var ModalContext = (0, import_react35.createContext)(void 0);
function useModalContext() {
  const context = (0, import_react35.useContext)(ModalContext);
  if (!context) {
...
var ModalHeader = ({
  ...
  const innerHeaderId = (0, import_react36.useId)();
...
// node_modules/flowbite-react/dist/esm/components/Modal/Modal.mjs
var ModalComponent = (0, import_react38.forwardRef)(
  ({
    children,
    className,
    dismissible = false,
    ...
    const [headerId, setHeaderId] = (0, import_react38.useState)(void 0);
...
function Popover({
  ...
  const [uncontrolledOpen, setUncontrolledOpen] = (0, import_react40.useState)(Boolean(initialOpen));
  ...
  const target = (0, import_react40.useMemo)(() => {
    return (0, import_react40.cloneElement)(
      children,
      getReferenceProps({
        ref,
    ...
    open && (0, import_jsx_runtime69.jsx)(FloatingFocusManager, { context, modal: true, children: (0, import_jsx_runtime69.jsx)(
      "div",
      {
        ...
        children: (0, import_jsx_runtime69.jsxs)("div", { className: "relative", children: [
          arrow2 && (0, import_jsx_runtime69.jsx)(
            "div",
            {
...
var Progress = ({
  ...
  return (0, import_jsx_runtime70.jsx)(import_jsx_runtime70.Fragment, { children: (0, import_jsx_runtime70.jsxs)("div", { id, "aria-label": textLabel, "aria-valuenow": progress, role: "progressbar", ...props, children: [
    ...
    (0, import_jsx_runtime70.jsx)("div", { className: twMerge(theme2.base, theme2.size[size], className), children: (0, import_jsx_runtime70.jsxs)("div", { style: { width: `${progress}%` }, className: twMerge(theme2.bar, theme2.color[color], theme2.size[size]), children: [
...
var RangeSlider = (0, import_react43.forwardRef)(
...
var RatingContext = (0, import_react44.createContext)(void 0);
function useRatingContext() {
  const context = (0, import_react44.useContext)(RatingContext);
  if (!context) {
...
var RatingComponent = ({ children, className, size = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime75.jsx)(RatingContext.Provider, { value: { theme: theme2, size }, children: (0, import_jsx_runtime75.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
    ...
    (0, import_jsx_runtime77.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          arrow2 && (0, import_jsx_runtime77.jsx)(
            "div",
            {
              className: twMerge(
                theme2.arrow.base,
...
var SidebarContext = (0, import_react48.createContext)(void 0);
function useSidebarContext() {
  const context = (0, import_react48.useContext)(SidebarContext);
  if (!context) {
...
var SidebarItemContext = (0, import_react49.createContext)(void 0);
function useSidebarItemContext() {
  const context = (0, import_react49.useContext)(SidebarItemContext);
  if (!context) {
...
var SidebarCollapse = ({
  ...
  const [isOpen, setOpen] = (0, import_react50.useState)(open);
  const { theme: rootTheme, isCollapsed } = useSidebarContext();
  const theme2 = mergeDeep(rootTheme.collapse, customTheme);
  (0, import_react50.useEffect)(() => setOpen(open), [open]);
...
var SidebarItem = (0, import_react51.forwardRef)(
  ({
    active: isActive,
    as: Component = "a",
    children,
...
var TableBodyContext = (0, import_react53.createContext)(void 0);
function useTableBodyContext() {
  const context = (0, import_react53.useContext)(TableBodyContext);
  if (!context) {
...
var TableContext = (0, import_react54.createContext)(void 0);
function useTableContext() {
  const context = (0, import_react54.useContext)(TableContext);
  if (!context) {
...
// node_modules/flowbite-react/dist/esm/components/Table/TableBody.mjs
var TableBody = (0, import_react55.forwardRef)(
...
var TableCell = (0, import_react56.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
var TableHeadContext = (0, import_react57.createContext)(void 0);
function useTableHeadContext() {
  const context = (0, import_react57.useContext)(TableHeadContext);
  if (!context) {
...
// node_modules/flowbite-react/dist/esm/components/Table/TableHead.mjs
var TableHead = (0, import_react58.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
    const { theme: rootTheme } = useTableContext();
...
var TableHeadCell = (0, import_react59.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
var TableRow = (0, import_react60.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
// node_modules/flowbite-react/dist/esm/components/Table/Table.mjs
var TableComponent = (0, import_react61.forwardRef)(
...
var TabsComponent = (0, import_react62.forwardRef)(
  ({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
    ...
    const tabs = (0, import_react62.useMemo)(
      () => import_react62.Children.map(
        import_react62.Children.toArray(children),
        ({ props: props2 }) => props2
      ),
      [children]
    );
    const tabRefs = (0, import_react62.useRef)([]);
    const [activeTab, setActiveTab] = (0, import_react62.useState)(
      Math.max(
        0,
        tabs.findIndex((tab) => tab.active)
      )
    );
    const [focusedTab, setFocusedTab] = (0, import_react62.useState)(-1);
    ...
    return (0, import_jsx_runtime93.jsxs)("div", { className: twMerge(theme2.base, className), children: [
      (0, import_jsx_runtime93.jsx)(
        "div",
        {
          ...
          ...props,
          children: tabs.map((tab, index) => (0, import_jsx_runtime93.jsxs)(
            "button",
            {
              type: "button",
      ...
      (0, import_jsx_runtime93.jsx)("div", { className: twMerge(theme2.tabitemcontainer.base, tabItemContainerStyle), children: tabs.map((tab, index) => (0, import_jsx_runtime93.jsx)(
        "div",
        {
...
var TimelineContentContext = (0, import_react64.createContext)(void 0);
function useTimelineContentContext() {
  const context = (0, import_react64.useContext)(TimelineContentContext);
  if (!context) {
...
var TimelineContext = (0, import_react65.createContext)(void 0);
function useTimelineContext() {
  const context = (0, import_react65.useContext)(TimelineContext);
  if (!context) {
...
var TimelineItemContext = (0, import_react66.createContext)(void 0);
function useTimelineItemContext() {
  const context = (0, import_react66.useContext)(TimelineItemContext);
  if (!context) {
...
var ToastContext = (0, import_react67.createContext)(void 0);
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  const [isClosed, setIsClosed] = (0, import_react68.useState)(false);
  const [isRemoved, setIsRemoved] = (0, import_react68.useState)(false);
...
var ToggleSwitch = (0, import_react69.forwardRef)(
  ({
    checked,
    className,
    color = "blue",
